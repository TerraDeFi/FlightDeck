...
const Left = () => {
    return (
        <div className="p-4 left justify-content-between">
            <p className="d-flex justify-content-between m-2"><span style={titleFont} className="h4 font-weight-bold">Borrow</span><span style={{fontWeight: "900", color: "#6C757D"}}> Slippage<span className="bg-black ms-1">&nbsp;&nbsp; 12% </span></span></p>
